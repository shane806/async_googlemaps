...
from async_googlemaps import convert
...
async def find_place(
  client, _input, input_type, fields=None, location_bias=None, language=None
):
  """
  ...
  :param _input: The text input specifying which place to search for (for
  ...
  """
  params = {"input": _input, "inputtype": input_type}
  ...
  return await client._request("/maps/api/place/findplacefromtext/json", params)
...
async def place(client, place_id, session_token=None, fields=None, language=None):
  """
...
async def _autocomplete(
  ...
  return (await client._request(url, params)).get("predictions", [])
