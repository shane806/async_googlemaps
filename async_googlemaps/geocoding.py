...
async def geocode(client, address=None, place_id=None, components=None, bounds=None, region=None,
            language=None):
    """
    ...
    return (await client._request("/maps/api/geocode/json", params)).get("results", [])
